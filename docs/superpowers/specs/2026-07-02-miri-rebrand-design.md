...
| Korean running text | `MIRI는 …` | final user decision 2026-07-02 (tried hangul 미리는, reverted): Latin brand + Korean particle in sentences; hangul 미리 only as the launcher label |
