...
//
// Plain CJS (not .ts): Expo's config loader transpiles only app.config.ts
// itself — nested imports go through Node's require, which cannot resolve
// an extensionless specifier to a .ts file.
...
module.exports = { SK_AD_NETWORK_ITEMS };
